...
class Payments {
	...
	/**
	 * Set the class name for the payment method
	 *
	 * @since 2.5.0.
	 */
	private function set_class_name() {
		$class_name = 'Bookit\Gateways\\' . ucwords( $this->payment_method ) . '\Merchant';
		...
		$class_name = 'Bookit\Classes\Payments\\' . ucwords( $this->payment_method );
