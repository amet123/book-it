...
class Translations {
	...
	public static function get_frontend_translations() {
		$translations = array(
			...
			'razorpay'                 => esc_html__( 'Pay now with Razorpay', 'bookit' ),
	...
	public static function payments_translations() {
		$translations = array(
			...
			'razorpay_key_id'          => esc_html__( 'Razorpay Key ID', 'bookit' ),
			'razorpay_key_secret'      => esc_html__( 'Razorpay Key Secret', 'bookit' ),
